...
import crimsonking.lottk.libraries.basegameutils.BaseGameUtils;
...
public class MainActivity extends Activity
    ...
    public static final String TAG = "LTK";

    // Google Api Client
    private GoogleApiClient mGoogleApiClient;

    // Are we resolving a connection failure?
    ...
    public void onCancelClicked(View view){
        ...
        Games.TurnBasedMultiplayer.cancelMatch(mGoogleApiClient,mMatch.getMatchId()).setResultCallback(new ResultCallback<TurnBasedMultiplayer.CancelMatchResult>() {
            @Override
            public void onResult(@NonNull TurnBasedMultiplayer.CancelMatchResult result) {
                processResult(result);
            }
        });
        isDoingTurn = false;
    ...
    public void onLeaveClicked(View view){
        ...
        Games.TurnBasedMultiplayer.leaveMatchDuringTurn(mGoogleApiClient, mMatch.getMatchId(), nextParticipantId).setResultCallback(
                new ResultCallback<TurnBasedMultiplayer.LeaveMatchResult>(){
                    @Override
                    public void onResult(@NonNull TurnBasedMultiplayer.LeaveMatchResult result){
                        processResult(result);
                    }
                });
        setViewVisibility();
    ...
    @Override
    public void onActivityResult(final int request, final int response, Intent data){
        ...
        if(request == RC_SIGN_IN){
            ...
            //Returning from the 'select matches' dialog
    ...
    public void updateMatch(TurnBasedMatch match){
        ...
        switch(status){
            case TurnBasedMatch.MATCH_STATUS_CANCELED:
                showWarning("Canceled!", "This game was cancelled.");
                return;
            case TurnBasedMatch.MATCH_STATUS_EXPIRED:
                showWarning("Expired!", "This game is expired. Sad!");
                return;
            case TurnBasedMatch.MATCH_STATUS_AUTO_MATCHING:
                showWarning("Waiting for auto-match...", "We're still waiting for an auto-match.");
                return;
            case TurnBasedMatch.MATCH_STATUS_COMPLETE:
                if(turnStatus == TurnBasedMatch.MATCH_TURN_STATUS_COMPLETE){
                    showWarning("Complete!", "This game is finished!");
                    break;
                }

                // Note that in this state, you must still call "Finish" yourself,
                // so we allow this to continue.
                showWarning("Complete!", "This game is over now!");
        ...
        switch (turnStatus){
            ...
            case TurnBasedMatch.MATCH_TURN_STATUS_THEIR_TURN:
                ...
                showWarning("Oops.. ","It's not your turn bud.");
                break;
    ...
    private void processResult(TurnBasedMultiplayer.CancelMatchResult result){
        ...
        showWarning("Match", "This match is cancelled. All other players will have their game ended.");
    }
    ...
    private void processResult(TurnBasedMultiplayer.InitiateMatchResult result){
        ...
        if(match.getData() != null){
            //this is a game that has already started, so just start
            updateMatch(match);
            return;
        }
    ...
    private boolean checkStatusCode(TurnBasedMatch match, int statusCode){
        switch (statusCode){
            ...
            case GamesStatusCodes.STATUS_NETWORK_ERROR_OPERATION_DEFERRED:
                ...
                // NOTE: This toast is for informative reasons only; remove
                // it from final application.
                return true;
